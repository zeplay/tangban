...
<title>~~~ Missing for you, So much... ~~~</title>
...
<SCRIPT language=javascript>
	var kt=false
	alert('Ê ! anh có một câu hỏi mún hỏi em nè ^^ !')
	alert('Trả lời cho chính xác nghen chưa ! ')
	alert('Câu hỏi cũng nhẹ nhàng thôi: ')
	alert('Đó là ...')
function move()
{
...
function dongy()
{
	...
	{
		alert('Ỏ ỏ! Iu à!')
		alert('Hỏi thế thôi, thật ra anh bít em iu từ lâu rồi ')
		alert('Iu mình nhiều lém hả?')
		alert('Bít mà, iu cực nhìu lun')
		alert('Thực tình anh cũng iu em lém ^^')
		alert('Iu từ lúc mới nhìn thấy em í ^^~')
		alert('I love U so much :X')
        window.location.href="ymsgr:sendIM?hoanghaivnn_hp&m=I LOVE YOU :x :x :X";       
		kt=true	
	}	
	else
	{
		alert('Goodbye my love^^')
	}
}
</SCRIPT>
<CENTER>
<DIV id=lbYes style="LEFT: 100px; POSITION: absolute; TOP: 210px;color:#FF0000;">
<h1>yes and no</h1>
</DIV>
<DIV id=lbYes style="LEFT: 100px; POSITION: absolute; TOP: 190px;z-index:2;"><INPUT style="CURSOR: pointer; COLOR: rgb(0,0,0)" onclick=dongy() type=button value="Yes :X "> 
</DIV>
<DIV id=lbNo style="LEFT: 220px; POSITION: absolute; TOP: 190px;z-index:2;"><INPUT onmousemove=move() style="CURSOR: pointer; COLOR: rgb(0,0,0)" type=button value="Hix, còn lâu "> 
</DIV>
</CENTER>
...
<html xml:lang="en" xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
		...
		<title>Anh <3 Em - Lý phục đế</title>	    
...
<!--
   ...
   __ __  //|          __     ____  ______      _   __  _  __
  / //_/ |/||  ___    / /    /  _/ /_  __/     | | / / / |/ /
 / ,<   / -_) / _ \  / _ \  _/ /    / /   _    | |/ / /    / 
...
-->
    ...
    <body>
        <div id="main">
            <div id="error">Trình duyệt của bạn không được hỗ trợ. Để được hỗ trợ liên hệ 0349984797 Hoặc sử dụng (<a href="http://www.google.cn/chrome">Chrome</a>) và (<a href="http://firefox.com/download/">Firefox</a>)</div>
             <div id="wrap">
                <div id="text">
			        <div id="code">
...
<span class="STYLE1"><span style="color: red; font-weight: bold; color:#FF0000;background: url(112.gif)"><i class="fas fa-star fa-spin"> Time of love...</span>
    ...
    (function(){
        ...
        var textAnimate = eval(Jscex.compile("async", function () {
		    ...
		    var year = 2026, month = 4, day = 14; // thay đổi ngày tháng năm tại đây
...
<body onload="javascript:teclear();">
    <div id="TextCounter">
        <strong>GÁI ĐẸP  
        <span style="color: red; font-weight: bold; color:#FF0000;background: url(112.gif)"><i class="fas fa-star fa-spin"><img alt="CN" loading="lazy" width="200" height="200" decoding="async" data-nimg="1" style="color:transparent" src="Screenshot_20260413-151928_Chrome.jpg"/>
...
'<font color="#FF0000" size="6"><span style="color: red; font-weight: bold; color:#FF0000;background: url(112.gif)"></i>em như hoa nở trong rừng , anh hóa thành sói , lao vào múp hoa , ahihihi</span><span style="color: red; font-weight: bold; color:#FF0000;background: url(112.gif)"><i class="fas fa-star fa-spin"><img alt="CN" loading="lazy" width="200" height="200" decoding="async" data-nimg="1" style="color:transparent" src="IMG_1776063983690_1776065682602.jpg"/></font><br>' +
